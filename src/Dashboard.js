...
function Dashboard() {
    ...
    return ( <
        ...
        <
        h2 >
        Bienvenida, Directora Norma Alvarez <
        /h2>
        ...
        <
        p >
        Monitoreo general de alumnos, asistencia y rendimiento académico. <
        /p> <
        /p> <
        /div>
        ...
        <
        /div> {/ * termina Alumnos en Riesgo * /}




        <
        /div> {/ * termina stat - grid * /} <
        div className = "weather-card mb-24" >

        <
        div className = "weather-left" >
        <
        div className = "weather-icon" > ☀️
        <
        /div>
        ...
        { /* QR */ } <
        QRCodeCanvas value = "http://172.20.10.3:3000"
        size = { 130 }
        />

        <
        div className = "small muted" >
        Escanee el código QR para acceder de una forma mas rapida desde tu celular <
        /div>
        ...
        <
        div style = {
            { marginBottom: "6px" } } > 👨‍🎓Alumnos: { totalAlumnos } <
        /div>

        <
        div style = {
            { marginBottom: "6px" } } > 🏫Grupos: { db.grupos.length } <
        /div>

        <
        div > ⚠️En riesgo: { enRiesgo.length } <
        /div> <
        /div>
        ...
        div className = "card-header" >
        <
        div className = "card-title" > 📋Actividad Reciente <
        /div> <
        /div>
        ...
        <
        span > 🟢08: 00 < /span> <
        p > Asistencia registrada para el grupo 3° A < /p> <
        /div>
        ...
        <
        span > 🔵09: 15 < /span> <
        p > Calificación actualizada en Matemáticas < /p> <
        /div>
        ...
        <
        span > 🟣10: 30 < /span> <
        p > Nuevo alumno agregado al sistema < /p> <
        /div>
        ...
        <
        span > 🟠11: 45 < /span> <
        p > Reporte académico generado < /p> <
        /div>
